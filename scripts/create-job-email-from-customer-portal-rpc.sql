-- Run in Supabase Dashboard → SQL Editor if customer portal "Send Message" fails (e.g. RLS blocks insert on job_emails).
-- This RPC lets portal users send messages by verifying their access token and inserting with SECURITY DEFINER.
