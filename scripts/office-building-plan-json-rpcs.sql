-- ============================================================
-- Office building plan JSON RPCs (manual / OnSpace SQL Editor)
-- ============================================================
-- OnSpace (*.backend.onspace.ai): PostgREST often does not expose multi-arg
-- RPCs in the schema cache. Use these single jsonb-parameter functions.
--
-- Prerequisites: building_plans + building_plan_versions tables exist
-- (supabase/migrations/20260325090000_building_plans_and_shares.sql).
--
-- Canonical copy: supabase/migrations/20260328140000_office_building_plan_json_rpcs.sql
-- ============================================================
