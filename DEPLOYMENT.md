...
- ✅ Versioned service worker (`public/sw.js`) with cache management
...
- ✅ Session saved in memory (AuthContext)
- ✅ Auto-restore on app reload
- ✅ Persists across updates and device restarts
- ✅ Only cleared on manual sign out

### 3. **PWA Support**
- ✅ Manifest.json configured
- ✅ App installable on mobile devices
- ✅ Proper theme colors (Martin Builder green)
...
- ✅ HTTPS ready (OnSpace handles this)
...
1. Click **"Publish"** → **"Add Existing Domain"**
...
### **Check Logs**
Use OnSpace's Cloud Dashboard → Log tab:
