/**
 * Line-level sell/cost for workbook material rows — matches MaterialsManagement getDisplayExtended
 * (Metal lineal: $/ft × length × qty; otherwise unit × qty or stored extended_*).
 */
...
/** Zoho Books line: amount ≈ quantity × rate — use workbook-consistent line total / billed quantity. */
