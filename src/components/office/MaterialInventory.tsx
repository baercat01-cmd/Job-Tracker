  ...
  return (
    <>
      ...
      >
        ...
        <TableCell className="font-medium">{group.parent_name}</TableCell>
        <TableCell>
          {group.category && (
      ...
      {isExpanded && group.items.map(item => (
        <TableRow key={item.sku} className="bg-muted/20">
          <TableCell></TableCell>
          ...
          <TableCell>
            <div className="flex items-center gap-4 text-sm">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="font-medium">
                  {item.purchase_cost?.toFixed(2) || '0.00'}
                </span>
          ...
          <TableCell colSpan={2}>
            {item.raw_metadata && Object.keys(item.raw_metadata).length > 0 && (
              <div className="flex items-center gap-1 text-xs text-muted-foreground">
                <FileText className="w-3 h-3" />
                <span>{Object.keys(item.raw_metadata).length} metadata fields</span>
              </div>
            )}
          </TableCell>
        </TableRow>
